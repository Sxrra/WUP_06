...
The data illustrates that the black people has equal percentage of people in favor or oppose capitol punishment. It also shows that the white and other races favor capitol punishment at almost an equal percentage.
...
This table reaffirms what was mentioned in the previous graph, that the Black group had almost equal percentages for favor and
oppose(49.55% vs 50.45%0. It also shows that in the White and Other group, there was almost an identical amount percentage-wise
of people who favor capital punishment (68.23% vs 68.75%) as well as oppose(31.77% and 31.25%)
...
The Fisher test shows us that the black and other group are in fact different. It also shows that the white and black group are different as well. It doesn't show any difference between the other and the white groups.
